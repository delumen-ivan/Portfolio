const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-neutral-900 to-neutral-950 text-white relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-primary-900/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-900/10 rounded-full blur-3xl"></div>
